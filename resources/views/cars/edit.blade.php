...
@section('content')
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $item->id }}" {{ $car->categorie_id == $item->id ? 'selected' : ''}}>{{ $item->name }}</option>
                                        @endforeach
                                        </select>
                                        @error('categorie_id')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $car->number  }}" class="form-control"
    ...
    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $car->model  }}" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $car->color }}" class="form-control"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $car->engine_type }}" class="form-control"
